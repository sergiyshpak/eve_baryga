...
Dim urls(1)
urls(0) ="https://eve-central.com/home/tradefind_display.html?set=1&fromt=10000016&to=10000002&qtype=Regions&age=24&minprofit=50000&size=8000&limit=100&sort=sprofit&prefer_sec=1"  ' lonetr to forge
urls(1) ="https://eve-central.com/home/tradefind_display.html?set=1&fromt=10000033&to=10000002&qtype=Regions&age=24&minprofit=50000&size=8000&limit=100&sort=sprofit&prefer_sec=1"  ' cita jita
...
for j = 0 to UBound(urls)
	...
	do while startpos>0
		...
		insigapos=InStr(1, itemStr,"nsignia")
		
		if ((profit1Num/totalmoneyNum)>CDbl(0.04) and (insigapos>0)) then 
